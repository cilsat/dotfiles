" Base16 Cil
" Scheme: cilsat 
" This scheme is based on the Mustang colorscheme. Instead of running
" Mustang's native colors it takes the base16 colors from the
" terminal. This is only meant for use with terminal Vim.
